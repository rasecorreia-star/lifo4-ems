...
export default function VirtualPowerPlant() {
  ...
  const currentSystemId = systemId || 'vpp-001';

  const { data: vppData, isLoading, isError } = useVPP(currentSystemId);
  ...
  const assets: VPPAsset[] = useMemo(() => vppData?.assets || defaultAssets, [vppData?.assets]);

  const defaultDispatchEvents: DispatchEvent[] = [
  ...
  const dispatchEvents: DispatchEvent[] = useMemo(() => vppData?.events || defaultDispatchEvents, [vppData?.events]);

  // Loading state
  if (isLoading) {
    return (
      <div className="flex items-center justify-center h-64">
        <div className="text-foreground-muted">Carregando dados da Virtual Power Plant...</div>
      </div>
    );
  }
  ...
  if (isError) {
    return (
      <div className="flex items-center justify-center h-64">
        <div className="text-danger-500">Erro ao carregar dados da Virtual Power Plant</div>
      </div>
    );
  }
  ...
  const realtimeData = useMemo(() => [
    { time: '00:00', power: 200, price: 180 },
    { time: '01:00', power: -150, price: 160 },
    { time: '02:00', power: -300, price: 140 },
    { time: '03:00', power: -250, price: 135 },
    { time: '04:00', power: 0, price: 145 },
    { time: '05:00', power: 500, price: 155 },
    { time: '06:00', power: 800, price: 170 },
    { time: '07:00', power: 1200, price: 185 },
    { time: '08:00', power: 1500, price: 210 },
    { time: '09:00', power: 1800, price: 230 },
    { time: '10:00', power: 2000, price: 245 },
    { time: '11:00', power: 2200, price: 255 },
    { time: '12:00', power: 1900, price: 250 },
    { time: '13:00', power: 1700, price: 240 },
    { time: '14:00', power: 1400, price: 235 },
    { time: '15:00', power: 1100, price: 225 },
    { time: '16:00', power: 800, price: 215 },
    { time: '17:00', power: -500, price: 250 },
    { time: '18:00', power: -800, price: 280 },
    { time: '19:00', power: -600, price: 270 },
    { time: '20:00', power: 400, price: 240 },
    { time: '21:00', power: 600, price: 220 },
    { time: '22:00', power: 300, price: 200 },
    { time: '23:00', power: 100, price: 190 },
  ], []);
