/**
 * SecurityZones
 * Camera security zones management for multi-zone monitoring
 * Route: /cameras/security-zones
 */
...
export default function SecurityZones() {
  ...
  const [newZoneType, setNewZoneType] = useState<'intrusion' | 'tripwire' | 'loitering' | 'line_crossing' | 'fire_detection' | 'smoke_detection'>('intrusion');
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <select
                      value={newZoneType}
                      onChange={(e) => {
                        setNewZoneType(e.target.value as 'intrusion' | 'tripwire' | 'loitering' | 'line_crossing' | 'fire_detection' | 'smoke_detection');
